...
Наследник всех своих родных.
        ...
        assertEquals(
            "здесь  пробелов  ",
            longestCommonSubSequence("здесь       много      пробелов    ", "а  здесь  пробелов  много")
        )
        assertEquals(
            "здесьетпробелов",
            longestCommonSubSequence("здесьнетпробелов", "а здесь есть пробелов")
        )
        assertEquals(
            "а,знак;препинания!",
            longestCommonSubSequence("а, что. насчёт: знаков; препинания?!", "а,знаки;препинания:тут!?")
        )
    }
    ...
    fun longestIncreasingSubSequence(longestIncreasingSubSequence: (List<Int>) -> List<Int>) {
        ...
        assertEquals(listOf(0, 1, 11, 22, 33, 44), longestIncreasingSubSequence(listOf(0, 1, 11, 2, 22, 3, 33, 4, 44)))
        assertEquals(listOf(-1, 0), longestIncreasingSubSequence(listOf(-1, -2, -3, -4, -5, 0, -6, -7, -8)))
